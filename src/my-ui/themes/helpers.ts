...
import {
  hslObjectToStringtinyColor,
  hslStringToNewFormat,
  hslStringToObjectTinyColor,
  hslStringToValidHsl,
} from "./colors";
...
export function groupByVariableName(variables: CSSVariableList): CSSVariableGroup {
